...
function Signup() {
  ...
  const submitUserDetails = async (e) => {
    ...
    axios.post("http://localhost:3000/api/v1/users/register", userData, {
    }).then((response) => {
    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 className="text-center text-2xl font-semibold">Contact<span className="text-blue-700">U</span></h2>
